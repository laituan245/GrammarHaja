...
public class DbHelper_GrammarInfoTable extends SQLiteOpenHelper {
    ...
    private static String MY_TABLE = "GrammarInformation";
    ...
    public ArrayList<GrammarRecord> getAllElements(boolean resultShouldBeSorted) {
        ArrayList<GrammarRecord> list = new ArrayList<GrammarRecord>();
        ...
        try {
            ...
            try {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        GrammarRecord obj = new GrammarRecord();
